...
loadObjects.eclipseBrooch = {name="Eclipse Brooch",x=62,y=52,w=10,h=10,text={look={"A brooch set with a magnificent", "black onyx stone. It's", "surrounded by many fine", "crystals and resembles a total", "elipse of the sun."},take={"You take the eclipse brooch."}},img=loadImages.eclipseBrooch,item={name="E. Brooch",w=42,h=4}}
...
loadObjects.necklace = {name="Necklace",x=62,y=52,w=10,h=11,text={look={"A silver necklace adorned", "with a small blue sapphire.", "It seems to have a", "strange but calming energy", "to it."},take={"You take the necklace."}},item={name="Necklace",w=37,h=4},img=loadImages.necklace}
...
loadObjects.shadowOrb = {name="Shadow Orb",x=65,y=30,w=16,h=16,text={look={"A mysterious orb of darkness."},take={"You take the shadow orb."}},img=loadImages.shadowOrb,item={name="Shadow Orb",w=47,h=4}}
