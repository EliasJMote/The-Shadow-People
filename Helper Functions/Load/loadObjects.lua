...
loadObjects.boltCutters = {name="Bolt Cutters",x=80,y=73,w=13,h=6,text={look={"A pair of bolt cutters. Use it", "to cut chains or padlocks."},take={"You take the bolt cutters."}},img=loadImages.boltCutters,item={name="B. Cutters",w=47,h=4}}
...
loadObjects.hammer = {name="Hammer",x=19,y=30,w=6,h=9,text={look={"A simple claw hammer. Generally used", "for working with nails, but can", "be used to smash things as well."},take={"You take the hammer."}},item={name="Hammer",w=28,h=4},img=loadImages.mirror}
...
loadObjects.shadowOrb = {name="Shadow Orb",x=80,y=51,w=10,h=5,text={look={"A mysterious orb of darkness."},take={"You take the shadow orb."}},img=loadImages.carKey,item={name="Shadow Orb",w=47,h=4}}
