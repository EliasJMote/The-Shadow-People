...
loadObjects.carKey = {name="Car Key",x=62,y=52,w=10,h=5,text={look={"A key that goes to your car.", "You won't make it far without", "it."},take={"You take the car key."}},img=loadImages.carKey,item={name="Car Key",w=33,h=4,description={"A key that goes to your car.", "You won't make it far without", "it."}}}

loadObjects.cog = {name="Cog",x=27,y=52,w=14,h=14,text={look={"A metal gear with many teeth."},take={"You take the cog."}},img=loadImages.cog,item={name="Cog",w=33,h=4,description={"A metal cog with many teeth."}}}
...
--[[loadObjects.gasCanister = {name="Gas Canister",x=17,y=55,w=9,h=11,text={look={"A canister full of gasoline."},take={"You take the gas canister."}},img=loadImages.gasCanister,item={name="Gas Can",w=32,h=4,description=}}]]
...
loadObjects.hammer = {name="Hammer",x=75,y=70,w=13,h=7,text={look={"A wooden mallet with a rubber", "head. Often used for flattening", "sheet metal but can be useful", "for smashing fragile objects."},take={"You take the hammer."}},item={name="Hammer",w=28,h=4,description={"A wooden mallet with a rubber", "head. Often used for flattening", "sheet metal but can be useful", "for smashing fragile objects."}},img=loadImages.hammer}
...
loadObjects.shadowOrb = {name="Shadow Orb",x=42,y=25,w=16,h=16,text={look={"A mysterious orb of darkness."},take={"You take the shadow orb."}},img=loadImages.shadowOrb,item={name="Shadow Orb",w=47,h=4,description={"A mysterious orb of darkness."}}}
