...
function loadLibraries.load()
    ...
    updateMouseWheelEvents = require("Helper Functions/Update/Update Events/updateMouseWheelEvents")
    ...
    drawPauseInstructionsScreen = require("Helper Functions/Draw/drawPauseInstructionsScreen")
    ...
    loadAchievementImages = require("Helper Functions/Load/Images/loadAchievementImages")
