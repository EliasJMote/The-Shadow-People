...
loadImages.townHub1Map = love.graphics.newImage("Images/Maps/Town Hub 1 Map.png")
loadImages.townHub2Map = love.graphics.newImage("Images/Maps/Town Hub 2 Map.png")
